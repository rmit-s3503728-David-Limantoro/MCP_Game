...
public class MonsterInfant extends Monster {
	...
	public MonsterInfant(Grid g, Player p, int row, int col, ArrayList<Monster> monsterArray, Setting sett) throws Exception {
		super(g, p, row, col, 0, monsterArray, sett);
