...
//					cells[k++] = cells2D[i][j];
	...
	/*
	 * returns the best direction from source cell to the target cell. Assumed
	 * cells passed are valid cells in the grid. you need to verify this method
	 */
	...
	/*
	 * A method to get the shortest distance from one cell to another Assumed
	 * cells are valid cells in the grid
	 */
